                   ...
                   <div class="col-sm-6">
                        ...
                        <div class="contactinfo">
                            <ul class="nav nav-pills">
                                ...
                                <li><a href="#"><i class="fa fa-envelope"></i>  driver.online@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                           ...
                           <a href="{{url('/')}}"><h1 style="text-decoration: none;">Driver App</h1></a>
                        </div>
...
<footer id="footer">
    <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Copyright © 2021 Driver APP </p>
