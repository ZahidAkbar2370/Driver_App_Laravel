...
<body>
	...
	<div class="navbar" style="background-color: #002347">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="{{url('admin-dashboard')}}"><span>Admin Panel</span></a>
			...
			<div id="sidebar-left" class="span2" style="background-color: #002347"> 
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{url('admin-view-customers')}}"><i class="icon-bar-chart"></i><span class="hidden-tablet">Customers</span></a></li>

						<li><a href="{{url('admin-view-drivers')}}"><i class="icon-bar-chart"></i><span class="hidden-tablet">Drivers</span></a></li>
	...
	<footer style="background-color: #002347">
		...
		<p>
			<span style="text-align:left;float:left">&copy; 2021 <a href="#" alt="Bootstrap Themes" style="color: white" target="_blank">Driver APP</a></span>
